...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'underscore', "/wp-includes/js/underscore$suffix.js", array(), '1.5.2', 1 );
	$scripts->add( 'backbone', "/wp-includes/js/backbone$suffix.js", array('underscore','jquery'), '1.1.0', 1 );
